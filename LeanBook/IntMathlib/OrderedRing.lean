...
--    intros a hpos b c hlt
--    apply MyInt.mul_lt_mul_of_pos_left hlt hpos
--  mul_lt_mul_of_pos_right := by
--    intros c hpos a b hlt
--    apply MyInt.mul_lt_mul_of_pos_right hlt hpos
...
--    intros a hnneg b c hlt
--    apply MyInt.mul_le_mul_of_nonneg_left hlt hnneg
--  mul_le_mul_of_nonneg_right := by
--    intros c hnneg a b hlt
--    apply MyInt.mul_le_mul_of_nonneg_right hlt hnneg
